function SubscribeNewsLetterSection() {
    return (
        <section className="section_py text-center bg-[#1D1F20] border-b border_soft">
            <p className="heading_sm md:text-[30px] md:leading-[33px] text_spacing" style={{ textShadow: "4px 4px 0 #000" }}>Subscribe to our newsletter</p>
            <div className="md:w-[810px] mx-auto px-[18px] md:px-0" >
                <form className="w-full flex flex-col md:flex-row md:items-center gap-5 md:gap-0" >
                    ...
                    >
                        <span className="group-hover:-mt-[50px] group-hover:duration-200" >Sign Up</span>
                        <span className="-mb-[50px] group-hover:mb-[-10.5px] group-hover:duration-200" >Sign Up</span>
                    </button>
                </form>
            </div>
        </section>
